...
module.exports = async (ctx) => {
    ...
    const loadMoreKey = next == null ? {} : JSON.parse(LZString.decompressFromBase64(next));
    ...
    const nextLoadMore = response.data.loadMoreKey == null ? null : LZString.compressToBase64(JSON.stringify(response.data.loadMoreKey));
